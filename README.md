...
Add the six pin socket for Programming1. If you're making a lot of boards, the alternative is to leave Programming1 empty and use one of these to make the contacts while you put the bootloader on: (3 pin, double row, 2.54mm)
